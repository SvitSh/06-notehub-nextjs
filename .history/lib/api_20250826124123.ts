...
/**
 * Base URL of the backend API.  This value is sourced from an environment
 * variable so that it can be customised without changing the source code.  See
 * `.env.example` for an example of how to configure this value.
 */
